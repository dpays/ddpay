...
describe('crypto', function() {
    ...
    const testnetPrefix = 'DWT'
    const testnetPair = {
        private: '5JQy7moK9SvNNDxn8rKNfQYFME5VDYC2j9Mv2tb7uXV5jz3fQR8',
        public: 'DWT8FiV6v7yqYWTZz8WuFDckWr62L9X34hCy6koe8vd2cDJHimtgM',
    }
    const mainPair = {
        private: '5K2yDAd9KAZ3ZitBsAPyRka9PLFemUrbcL6UziZiPaw2c6jCeLH',
        public: 'DWB8QykigLRi9ZUcNy1iXGY3KjRuCiLM8Ga49LHti1F8hgawKFc3K',
    }
    ...
    it('should decode public keys', function() {
        ...
        const k3 = new PublicKey(mainPairPub, 'DWB')
    ...
    it('should conceal private key when inspecting', function() {
        ...
        assert.equal(inspect(key.createPublic(testnetPrefix)), 'PublicKey: DWT8FiV6v7yqYWTZz8WuFDckWr62L9X34hCy6koe8vd2cDJHimtgM')
    })
    ...
    it('should create key from login', function() {
        ...
        assert.equal(key.createPublic().toString(), 'DWB87F7tN56tAUL2C6J9Gzi9HzgNpZdi6M2cLQo7TjDU5v178QsYA')
    })
    ...
    it('should sign and verify transaction', function() {
        ...
        assert.equal(sig.recover(digest).toString(), 'DWB7s4VJuYFfHq8HCPpgC649Lu7CjA1V9oXgPfv8f3fszKMk3Kny9')
    })
