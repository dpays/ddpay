...
describe('operations', function() {
    ...
    it('should transfer BEX', async function() {
        ...
        assert.equal(Asset.from(acc2af.balance).subtract(acc2bf.balance).toString(), '0.042 BEX')
    })
    ...
    it('should create account and post with options', async function() {
        ...
        await client.broadcast.commentWithOptions({
            ...
            max_accepted_payout: Asset.from(10, 'BBD'),
            extensions: [
                [0, {beneficiaries: [
        ...
        assert.equal(post.max_accepted_payout, '10.000 BBD')
    ...
    it('should create account and calculate fees', async function() {
        ...
        await client.broadcast.createAccount({
            ...
            fee: '2.000 BEX', delegation: Asset.from(1000, 'VESTS')
        }, acc1Key)
