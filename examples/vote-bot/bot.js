...
// setup the ddpay client, you can use other nodes, for example gtg's public node at wss://d.dpays.io
const client = new ddpay.Client('wss://d.dpays.io')

// deserialize the posting key (in wif format, same format as you find on the dSite.io interface)
const key = ddpay.PrivateKey.fromString(POSTING_KEY)
